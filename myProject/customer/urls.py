...
urlpatterns = [
    ...
    path('getemp/', views.handleGet, name="getEmp-by id"),  # welcome page
    path('getemp1/', views.handleGet1, name="getemp1 by name"),  # welcome page
    path('dltemp/', views.handleDlt, name="delete-page"),  # welcome page
    #path('dltemp/', views.handleDlt1, name="index page"),  # welcome page

    path('editEmployee/', views.handleUpdate, name="editEmployee page"),  # welcome page
